...
const scrapingSuper7 = require('../scrappers/super7.js');
...
async function scrapeSuper7() {
  ...
  const maxPages = 50; // Number of pages to scrape for Super7
  let newCount = 0;
  let updateCount = 0;
  let errorCount = 0;
  let scrapedCount = 0;

  console.log('Starting Super7 scrape...');
  ...
  for (let page = 1; page <= maxPages; page++) {
    ...
    try {
      ...
      const prods = await scrapingSuper7.scrapeSuper7Vari(page);
